...
# for verifiable encryption in Section 6.3 for prime p which is coprime to q. 
...
print("Total proof size in KB: ", round((full_size + challenge + short_size1 + short_size2)/(2^13) , 2))
